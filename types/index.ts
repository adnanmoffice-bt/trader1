...
export type AgentName = 'orchestrator' | 'market-analyst' | 'signal-generator' | 'risk-manager' | 'trade-reviewer' | 'polymarket-scanner' | 'bull-agent' | 'bear-agent' | 'correlation-agent' | 'macro-agent' | 'scalper-agent' | 'trend-agent' | 'master-agent' | 'profit-engine' | 'kill-switch'
